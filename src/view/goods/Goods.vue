...
.priceBox1 p:first-child {
  text-decoration: line-through;
}
.priceBox1 p span:first-child {
  display: inline-block;
  width: 80px;
}
.priceBox1 p:last-child span:last-child {
  font-size: 20px;
  color: orange;
}
.priceBox2 {
